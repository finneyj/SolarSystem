...
{
    /**
     * Add a new solar object with the given characterisitcs, that does not orbit around anything. (e.g. sun)
     ...
     */
    public void add(String name, double initialAngle, double size, String colour);
